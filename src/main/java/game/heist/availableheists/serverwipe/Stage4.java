...
public class Stage4 implements Stage {
    ...
    public MessageEmbed ask(String p, User user) {
        ...
        embedBuilder.setDescription("There are three doors");

        embedBuilder.addField("`" + p + "HA`",
                "Enter this to go up the left door", false);
        embedBuilder.addField("`" + p + "HB`",
                "Enter this to go up the middle door", false);
        embedBuilder.addField("`" + p + "HC`",
                "Enter this to go up the right door", false);
    ...
    public MessageEmbed success(User user) {
        ...
        embedBuilder.setDescription("**Antonio** Perfect! Now plant those bombs and blow this place to dust!");
