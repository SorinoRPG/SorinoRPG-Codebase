...
public class Stage1 implements Stage {
    ...
    public MessageEmbed ask(String p, User user) {
        ...
        embedBuilder.setTitle("You and your team dress up in suits and enter the building");
        ...
        embedBuilder.addField("`" + p + "HB`",
                "Enter this to input 'STCK21'", false);
        embedBuilder.addField("`" + p + "HC`",
                "Enter this to input 'MASN64'", false);
        embedBuilder.setFooter("password: STCK21");
    ...
    public MessageEmbed success(User user) {
        ...
        embedBuilder.setDescription("**Marcus** Haha, we are in!!");
