...
public class Stage2 implements Stage {
    ...
    public MessageEmbed ask(String p, User user) {
        ...
        embedBuilder.setTitle("You and your team walk deeper into the building");
        embedBuilder.setDescription("There is a person who has never recognized you");
    ...
    public MessageEmbed success(User user) {
        ...
        embedBuilder.setDescription("**Marcus** He did not suspect a thing!");
