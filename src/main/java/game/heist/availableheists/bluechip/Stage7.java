...
public class Stage7 implements Stage {
    ...
    public MessageEmbed ask(String p, User user) {
        ...
        embedBuilder.addField("`" + p + "HA`",
                "Enter this to input 'GUY129'", false);
        embedBuilder.addField("`" + p + "HB`",
                "Enter this to input 'C421'", false);
        embedBuilder.addField("`" + p + "HC`",
                "Enter this to input 'LRC89'", false);
        embedBuilder.setFooter("password: GUY129");
    ...
    public MessageEmbed success(User user) {
        ...
        embedBuilder.setAuthor(user.getName() + "'s turn");
        embedBuilder.setTitle("You entered the correct password and got all the data!");
        embedBuilder.setDescription("**Marcus** Ok excellent, now get out of there!");
